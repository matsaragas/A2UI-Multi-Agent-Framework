  ...
  async def build_agent(
    ...
    agent = LlmAgent(
        ...
        instruction=(
            ...
            "IMPORTANT: If a subagent returns a JSON payload (A2UI), you MUST output"
            " that JSON string EXACTLY as it was received. Do NOT wrap it in Markdown"
            " code blocks, do NOT add introductory text, and do NOT modify the JSON."
        ),
        tools=[],
